...
class MyFirebase():
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get(f"https://aplicativovendas-f1070-default-rtdb.firebaseio.com/proximo_id_vendedor.json?auth={id_token}")
            id_vendedor = req_id.json()

            link = f"https://aplicativovendas-f1070-default-rtdb.firebaseio.com/{local_id}.json?auth={id_token}"
            ...
            requests.patch(f"https://aplicativovendas-f1070-default-rtdb.firebaseio.com/.json?auth={id_token}", data=info_id_vendedor)
